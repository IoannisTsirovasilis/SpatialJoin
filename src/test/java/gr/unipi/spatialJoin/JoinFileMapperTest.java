...
public class JoinFileMapperTest extends TestCase {
    ...
    public void testBuildGridCreatesProperGrid() throws IOException, InterruptedException {    	
    	Text record = new Text("3|Alameda County Fairgrounds|0|28|37.5|-121.887367|laundry_service,meeting_rooms,event_catering,complimentary_breakfast,internet,internet_wireless,pets,fitness_facilities");
		...
		new MapDriver<LongWritable, Text, TextPair, TextPair>()
			...
			.withOutput(new TextPair("3", "1"), new TextPair("Alameda County Fairgrounds", "1"))
